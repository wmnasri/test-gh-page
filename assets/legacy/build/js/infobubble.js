...
InfoBubble.prototype.buildDom_ = function() {
  ...
  var maps_protocol = document.location.protocol;
  close.src = maps_protocol + '//maps.gstatic.com/intl/en_us/mapfiles/iw_close.gif';
  /* END 8875 */
  var that = this;
...
InfoBubble.prototype.draw = function() {
  ...
  this.bubble_.style['top'] = this.px(top-10);
