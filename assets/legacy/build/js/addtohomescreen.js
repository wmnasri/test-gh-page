...
ath.intl = {
	...
	fr_fr: {
		message: 'Pour ajouter ce site sur votre écran d\'accueil, appuyer sur %icon puis sur %icon2 <strong>%action</strong>',
		action: { ios: 'Sur l\'écran d\'accueil', android: 'Aj. raccourci écran acc.', windows: 'épingler sur l\'écran d\'accueil' }
	}
};
...
ath.Class.prototype = {
	...
	show: function (force) {
		...
		message = '<p>' + message.replace('%icon2', '<span class="ath-action-icon-2">icon</span>') + '</p>';
