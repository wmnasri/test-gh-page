...
export default class EzBtnHeading4 extends EzButton {
    static get key() {
        return 'ezheading4';
    }
        ...
        return (
            <button className={css} onClick={this.addHeading.bind(this)} tabIndex={this.props.tabIndex} title={label}>
                <svg className="ez-icon ez-btn-ae__icon">
                    <use xlinkHref="/bundles/ezplatformadminui/img/ez-icons.svg#h4" />
                </svg>
            </button>
        );
    }
...
AlloyEditor.Buttons[EzBtnHeading4.key] = AlloyEditor.EzBtnHeading4 = EzBtnHeading4;
